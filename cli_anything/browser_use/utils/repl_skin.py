...
_ACCENT_COLORS = {
    ...
    "browser_use": "\033[38;5;45m",    # cyan-blue for browser-use
}
...
class ReplSkin:
    ...
    def __init__(self, software: str, version: str = "1.0.0",
        ...
        Args:
            software: Software name (e.g., "gimp", "shotcut", "browser-use").
    ...
    def print_banner(self):
        ...
        # Title:  ◆  cli-anything · Browser-Use
...
_ANSI_256_TO_HEX = {
    ...
    "\033[38;5;45m":  "#00afd7",  # browser-use cyan-blue
